...
class StatusQueryDto extends paginated_query_dto_1.PaginatedQueryDto {
    constructor() {
        super(...arguments);
        this.status = null;
    }
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: false, type: () => Boolean, nullable: true, default: null } };
    }
}
...
], StatusQueryDto.prototype, "status", void 0);
